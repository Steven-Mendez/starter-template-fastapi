...
#### Scenario: Health response includes persistence contract fields
- **WHEN** a client receives `GET /health` response
- **THEN** the response body SHALL include `persistence.backend` and `persistence.ready` fields
