...
The system SHALL represent card movement invariants and ordering semantics through domain-level types and methods/specifications encapsulated as behaviors on Aggregate Roots or child entities, avoiding Anemic Data Models.
...
#### Scenario: Rich entities execute domain logic internally

- **WHEN** an application handler initiates a card movement
- **THEN** it SHALL invoke an aggregate domain method rather than relying on isolated procedural functions in the application layer
