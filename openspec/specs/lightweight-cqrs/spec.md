...
Define command/query separation at the application structure level without requiring distributed messaging, event sourcing, or projection infrastructure.
