...
The system SHALL represent an attempt to move a card to a column on a different board as a failure distinct from a simple missing id where useful for tests.
