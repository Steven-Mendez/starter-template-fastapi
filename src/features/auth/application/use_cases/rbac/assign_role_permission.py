...
class AssignRolePermission:
    ...
    def execute(
        ...
        *,
        ...
        if not self._repository.assign_role_permission(role_id, permission_id):
            return Err(NotFoundError("Role or permission not found"))
        ...
        self._repository.record_audit_event(
            event_type="rbac.role_permission_added",
